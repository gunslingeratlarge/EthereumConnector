...
import cn.ssc.blockchain.generatedByte.DevToken;
...
public class BlockChainByteImpl implements BlockChainByte{
    private Admin web3;
    private Credentials credentials;
    private DevToken contract;
    Logger logger = LoggerFactory.getLogger(getClass());

    private Configuration config = new PropertiesConfiguration("blockchainByte.properties");
    public BlockChainByteImpl() throws ConfigurationException {
    ...
    public String publishProjectAndSendBP(String publisher, String publishTime, String projectName, String projectHash,byte[] bp) throws Exception {
        TransactionReceipt receipt = contract.publishProjectAndSendBP(publisher, publishTime, projectName, projectHash,bp).send();
        return  receipt.getTransactionHash();
    }
